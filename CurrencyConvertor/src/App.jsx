...
function App() {
  ...
  return (
    <div className='w-full h-screen flex flex-wrap justify-center items-center bg-contain bg-no-repeat bg-center'
    style={{backgroundImage:`url('https://png.pngtree.com/png-vector/20190523/ourlarge/pngtree-exchangecurrencyfinancemoneyconvert-flat-line-filled-ico-png-image_1060332.jpg')`}}>
